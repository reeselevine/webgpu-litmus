...
function randomConfig() {
  ...
  return {
    ...
    scratchMemorySize: 4 * stressLineSize * stressTargetLines,
    memStride: memStride,
...
export default function stressPanel(props) {
  const uiParams = {
    ...
    testMemorySize : buildIntStressParam("Test Memory Size", "The size of the memory buffer that contains the global testing locations (values should be between 256 and 4096)", "testMemorySize",props.params, props.pageState, 256, 4096),
