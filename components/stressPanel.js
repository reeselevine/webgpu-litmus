...
export function getStressPanel(params, pageState) {
  const uiParams = {
    ...
    memStride : buildIntStressParam("Memory Stride", "The testing locations in the litmus test are guaranteed to be seperated by at least this many 32-bit words (values should be between 1 and 128)", "memStride", params, pageState, 2, 512 ),
    ...
    scratchMemorySize : buildIntStressParam("Scatch Memory Size", "The size of the memory buffer where threads stress the memory" , "scratchMemorySize", params, pageState, 256, 524288),
