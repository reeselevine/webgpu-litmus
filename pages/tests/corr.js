...
export default function CoRR() {
  ...
  function doCoRR() {
    ...
    const p = runLitmusTest(shaderCode, testParams, iterations, handleResult, state);
    p.then(
      success => {
        setLoading(false);
        console.log("success!")
  ...
  <>
    <div className="columns">
      <div className="column">
        <h1 className="testName">CoRR</h1>
          <h2 className="testDescription">The CoRR litmus test checks to see if memory is coherent.</h2>
      </div>
    </div>
    <div className=" columns">
    <div className=" column">
